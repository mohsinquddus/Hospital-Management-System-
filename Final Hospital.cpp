...
void doctor::delete_record(){
	...
	if(!read){
		...
		if(count==0){
			cout<<"Your Record Cannot  DELETE Beacuse Record Found "<<endl;
		}
		else{
...
if(number==2){
	...
	cout<<"\t\t\t\t Press 5----------Search patient with phone num"<<endl;
	cout<<"\t\t\t\t Press 6----------Update Record "<<endl;
	cout<<"\t\t\t\t Press 7----------Delete Record "<<endl;
